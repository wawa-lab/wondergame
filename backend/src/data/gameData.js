...
const heroCharacter = {
  ...
  skills: {
    ...
    morality: 0,        // 道德值 - 品行操守（善举/助人积累，不良行为降低）
    arithmetic: 0,      // 算数值 - 数术计算（珠算/天文积累）
    crafting: 0,        // 手工值 - 制作技艺（陶瓷/锻造/木工积累）
    evil: 0,            // 邪恶值 - 选择黑暗道路积累，达到60触发消极结局
  },
...
const ENDINGS = [
  ...
  },
  {
    ...
    rarity: 'bad',
    image: '/assets/endings/bad_overwork.jpeg',
    description: '那些黑暗的选择，像一根根刺，悄悄扎进你的灵魂。你骗了无辜的孩童，辜负了落魄的书生，窃取了老者的药材……恶名渐渐在京城传开，人们对你避而远之。18岁那年，你孤立无援，再无人愿意与你为伍。那些曾被你伤害的人的眼神，在暗夜里一遍遍出现，让你再也无法安眠。你在孤独与悔恨中走完了余生，没有人记得你曾有过的善意，只留下一个令人唾弃的名字。',
    flavor: '每一次黑暗的选择，都是在亲手编织囚禁自己的枷锁。',
    check: (s) => (s.skills.evil || 0) >= 60,
    priority: 101,  // 高于积劳成疾，邪恶结局优先触发
  },
  // ==================== 婚恋结局 ====================
